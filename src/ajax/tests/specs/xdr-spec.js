...
KISSY.use("ua,json,ajax,node", function (S, UA, JSON, io, Node) {
    ...
    describe("Xdr IO", function () {
        ...
        it("should works for any domain", function () {
            ...
            io({
                ...
                url:'http://yiminghe.taobao.com/' +
                    'kissy_git/kissy1.3rc/src/ajax/tests/others/xdr/xdr.php',
                xhrFields:{
        ...
        it("should works for subdomain", function () {
            ...
            io({
                url:'http://yiminghe.taobao.ali.com/kissy_git/kissy1.3rc/src/ajax/tests/data/ajax.php',
                xdr:{
                    subDomain:{
                        proxy:"/kissy_git/kissy1.3rc/src/ajax/tests/others/subdomain/proxy.html"
                    }
                },
                success:function () {
                    ret.push('s');
        ...
        it("should support cross subdomain fileupload", function () {
            ...
            io({
                form:form[0],
                dataType:'json',
                url:'http://yiminghe.taobao.ali.com/kissy_git/kissy1.3rc/src/ajax/tests/others/subdomain/upload.php',
